...
import p from '../../assets/avator.png'
const About = () => {

const stats=[
  {label:"Projects",value:"25+"},
  {label:"Focus",value:"Perforemance and UI/UX"},
  {label:"Experience",value:"Fresher"},
]


  const glows=[
    "-top-10 -left-10 w-[360px] h-[360px] opacity-30 blur-[120px]",
    "bottom-0 right-10 w-[420px] h-[300px] opacity-15 blur-[140px] delay-300",
      ...
      <div className='relative z-10 max-w-6xl w-full mx-auto px-6  md:px-10 lg:px-12 py-20 flex flex-col gap-12'>
        ...
        viewport={{once:true,amount:0.4}}>
          ...
          transition={{type:"spring",stiffness:200,damping:18}}>
            <img src={p} alt="photo" className='absolute inset-0' />
          </motion.div>
